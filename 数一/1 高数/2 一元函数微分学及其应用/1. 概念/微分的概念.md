...
- $(\Delta x)^2$ 即为 $o(\Delta x)$。它为 $\Delta x \to 0$ 时的高阶[[数一\1 高数\1 函数 极限与连续\无穷小|无穷小]]，是**误差**。
...
$\mathrm{d}y$ 和 $\Delta y$ 不同。二者相差一个高阶[[数一\1 高数\1 函数 极限与连续\无穷小|无穷小]]的误差。
 [[Excalidraw/习题/第三讲习题.md#^5Fe9gdav]]
## 注：
