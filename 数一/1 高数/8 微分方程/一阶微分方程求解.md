...
## [[数一\1 高数\8 微分方程\可分离变量型微分方程|可分离变量型微分方程]]

### 直接可分离

*能写成* $y' = f(x) g(y)$ 形式的方程称为[[数一\1 高数\8 微分方程\可分离变量型微分方程|可分离变量型微分方程]]。
...
## [[数一\1 高数\8 微分方程\齐次型微分方程|齐次型微分方程]]

形如 $\frac{\mathrm{d}y}{\mathrm{d}x} = \varphi \left(\frac{y}{x} \right)$ 的方程叫做[[数一\1 高数\8 微分方程\齐次型微分方程|齐次型微分方程]]。
...
## [[数一\1 高数\8 微分方程\一阶线性微分方程|一阶线性微分方程]]

#重要 

形如 $y' + p(x)y = q(x)$ 的方程叫做[[数一\1 高数\8 微分方程\一阶线性微分方程|一阶线性微分方程]]。
...
## [[数一\1 高数\8 微分方程\伯努利方程|伯努利方程]]*

形如 $$\frac{\mathrm{d}y}{\mathrm{d}x} + p(x)y = q(x)y^{n} (n \ne 0, 1)$$ 的方程叫做[[数一\1 高数\8 微分方程\伯努利方程|伯努利方程]]。
...
3. 解[[数一\1 高数\8 微分方程\一阶线性微分方程|一阶线性微分方程]]即可。
